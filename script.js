const content = [
    ...
    { title: 'Libro', description: 'Final Examen - Computer Science', type: 'Examen', semester: '1', subject: 'Análisis vectorial', link: 'Material/1/Analisis vectorial.pdf' },
    ...
    { title: 'Libro', description: 'Advanced Mathematics', type: 'Libro', semester: '1', subject: 'Matemáticas discretas', link: 'Material/1/lista-15-grafos-siete-ejrcicios-resueltos.pdf' },
    { title: 'Examen', description: 'Midterm Examen - Physics', type: 'Examen', semester: '1', subject: 'Comunicación oral y escrita', link: 'Material/1/ensayo-20-parcial-jesus-vargas.pdf' },
    ...
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '2', subject: 'Ingeniería, ética y sociedad', link: 'Material/2/cuadro-comparativo-de-las-cuatro-revoluciones-industriales.pdf' },
    { title: 'Examen', description: 'Final Examen - Chemistry', type: 'Examen', semester: '2', subject: 'Fundamentos económicos', link: 'Material/2/campos-economia-apuntes-donde-se-explican-los-actores-la-micro-y-macro-ecomia.pdf' },
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '2', subject: 'Algoritsmo y estructura de datos', link: 'Material/2/listado-uno-de-problemas-algoritmos-y-estructura-de-datos.pdf' },
    //TERCER SEMESTRE  
    ...
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '3', subject: 'Circuitos eléctricos', link: 'Material/3/ejercicios-circuitos-inductores-resistivos-paralelo.pdf' },
    { title: 'Examen', description: 'Final Examen - Chemistry', type: 'Examen', semester: '3', subject: 'Fundamentos de diseño digital', link: 'Material/3/practica-2-ulises-juarez.pdf' },
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '3', subject: 'Bases de datos', link: 'Material/3/practica-2-ulises-juarez.pdf' },
    { title: 'Examen', description: 'Final Examen - Chemistry', type: 'Examen', semester: '3', subject: 'Finanzas empresariales', link: 'Material/3/Finanzas empresariales.pdf' },
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '3', subject: 'Paradigmas de programación', link: 'Material/3/guia2paradig-paradigmas-de-programacion.pdf' },
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '3', subject: 'Análisis y diseño de algoritmos', link: 'Material/3/66problemas-resueltos-de-analisis-ydiseno-algoritmos-rarruabarrena-jbermudez-2004-0202.pdf' },
    //CUARTO SEMESTRE  
    ...
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '4', subject: 'Diseño de sistemas digitales', link: 'Material/4/tipo-de-memorias-dsd-tarea-final.pdf' },
    { title: 'Examen', description: 'Final Examen - Chemistry', type: 'Examen', semester: '4', subject: 'Tecnologías para el desarrollo de aplicaciones web', link: 'Material/4/tdaw-tarea-31-4cm1-ejercicio-desarrollado-en-clase.pdf' },
    ...
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '4', subject: 'Teoría de la computación', link: 'Material/4/ejercicios-de-practica.pdf' },
    //QUINTO SEMESTRE Material/5/.pdf
    { title: 'Examen', description: 'Final Examen - Chemistry', type: 'Examen', semester: '5', subject: 'Procesamiento digital de señales', link: 'Material/5/apuntes-todos-los-temas.pdf' },
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '5', subject: 'Instrumentación y control', link: 'Material/5/381079688-practica-6-controlador-de-dos-pasos.pdf' },
    { title: 'Examen', description: 'Final Examen - Chemistry', type: 'Examen', semester: '5', subject: 'Arquitectura de computadoras', link: 'Material/5/sistema-windows-y-linux.pdf' },
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '5', subject: 'Análisis y diseño de sistemas', link: 'Material/5/analisis-y-diseno-de-sitemas-semana-3.pdf' },
    ...
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '5', subject: 'Compiladores', link: 'Material/5/primerosiguiente-apuntes-first-y-follow.pdf' },
    { title: 'Examen', description: 'Midterm Examen - Biology', type: 'Examen', semester: '5', subject: 'Redes de computadoras', link: 'Material/5/redes-de-computadoras-s2.pdf' },
    //SEXTO SEMESTRE
